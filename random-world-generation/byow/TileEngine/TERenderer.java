...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        StdDraw.filledRectangle(Engine.WIDTH / 2.0, Engine.HEIGHT + 2, numXTiles / 2.0, 2);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(Engine.WIDTH / 3.0, Engine.HEIGHT + 2, "Press" + " " + "p" + " " + "for" + " "
                + "enemy" + " " + "path");

        switch (display) {
            case 1:
                StdDraw.text(Engine.WIDTH / 1.5, Engine.HEIGHT + 2, "Tile:" + " " + "floor");
                break;
            case 2:
                StdDraw.text(Engine.WIDTH / 1.5, Engine.HEIGHT + 2, "Tile:" + " " + "wall");
                break;
            case 3:
                StdDraw.text(Engine.WIDTH / 1.5, Engine.HEIGHT + 2, "Tile:" + " " + "you!!!");
                break;
            case 4: default:
                StdDraw.text(Engine.WIDTH / 1.5, Engine.HEIGHT + 2, "Tile:" + " " + "darkness");
                break;
        }
        StdDraw.show();
    }
