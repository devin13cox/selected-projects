...
def free_bacon(score):
    ...
    "*** YOUR CODE HERE ***"
    onesdigit = score % 10
    tensdigit = (score // 10) % 10
    digit = abs(onesdigit - tensdigit)
    points = digit + 2
    if points <= 10:
        return points
    else:
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    "*** YOUR CODE HERE ***"
    def say(score0, score1):
        announcement = "That's the biggest gain yet for "
        new_high = previous_high
        score = previous_score
        if who == 0:
            score = score0
            announcement = announcement + "Player 0"
        elif who == 1:
            score = score1
            announcement = announcement + "Player 1"
        if (score - previous_score) > previous_high:
            new_high = (score - previous_score)
            if new_high == 1:
                announcement = "1 point! " + announcement
            else:
                announcement = str(new_high) + " points! " + announcement
            print(announcement)
...
def make_averaged(fn, num_samples=1000):
    ...
    def average(*args):
            ...
            while counter < num_samples:
                points = points + fn(*args)
                counter += 1
            average = points / num_samples
            return average
    return average
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_dice > 0:
        ...
        average = avg(num_dice, dice)
        high_score = max(average, high_score)
        if average == high_score:
            winning_die = num_dice
        num_dice -= 1
    return winning_die
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # Picking Best Roll to Win Game on Current Turn
    ...
    # Picking Best Roll While Down
    if (opponent_score - score) >= 18:
        return swap_strategy(score, opponent_score, margin=11, num_rolls=10)
    if (opponent_score - score) >= 9:
        return swap_strategy(score, opponent_score, margin=9, num_rolls=7)
    
    # Picking Best Roll While Up Significantly
    if (score - opponent_score) >= 9:
        return swap_strategy(score, opponent_score, margin=6, num_rolls=4)
    
    # Picking Best Roll Under Normal Circumstances
